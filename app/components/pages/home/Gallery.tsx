    ...
    return <SectionContainer>
        <div className="container">
            ...
            <LightGalleryWrapper elementClassNames='grid lg:grid-cols-12 gap-4'>
                <Image src={skladPic} className="h-full w-full col-span-4" alt="Склад" />
                <Image className="h-full w-full col-span-4" src={pogruzkaPic} alt="Процесс погрузки продукции" />
                <Image className="h-full w-full col-span-4" src={dorogaNaSklad} alt="Листы оцинкованные №5" />
                <Image className="h-full w-full col-span-3" src={listyOcinkovannyj1} alt="Листы оцинкованные №1" />
                <Image className="h-full w-full col-span-3" src={listyOcinkovannyj2} alt="Листы оцинкованные №2" />
                <Image className="h-full w-full col-span-3" src={listyOcinkovannyj3} alt="Листы оцинкованные №3" />
                <Image className="h-full w-full col-span-3" src={listyOcinkovannyj4} alt="Листы оцинкованные №4" />
            </LightGalleryWrapper>
        </div>
    </SectionContainer>
}
